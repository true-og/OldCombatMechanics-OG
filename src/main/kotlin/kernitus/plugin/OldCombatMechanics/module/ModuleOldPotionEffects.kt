...
class ModuleOldPotionEffects(plugin: OCMMain) : OCMModule(plugin, "old-potion-effects") {
    ...
    companion object {
        private val EXCLUDED_POTION_TYPES: Set<PotionTypeCompat> =
            mutableSetOf( // Base potions without any effect
    ...
    fun onDamageByEntity(event: OCMEntityDamageByEntityEvent) {
        ...
        if (event.hasWeakness) {
            ...
            debug("Old weakness modifier: " + event.weaknessLevel + " New: " + newWeaknessModifier, damager)
        }
