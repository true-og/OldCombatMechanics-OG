...
/**
 * Spigot versions below 1.16 did not have way of getting attack cooldown. Obtaining through NMS works, but value is
 * reset before EntityDamageEvent is called. This means we must keep track of the cooldown to get the correct values.
 */
