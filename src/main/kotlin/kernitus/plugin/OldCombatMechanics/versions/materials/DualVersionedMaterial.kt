 ...
 */
(private val oldItem: Supplier<ItemStack>, private val newItem: Supplier<ItemStack>) : VersionedMaterial {
    ...
    private val itemSupplier: Supplier<ItemStack>
        get() = if (Reflector.versionIsNewerOrEqualTo(1, 13, 0)) newItem else oldItem

    override fun toString(): String {
        return ("DualVersionedMaterial{" +
            "picked=" +
            (if (itemSupplier === newItem) "new" else "old") +
            ", item=" +
            newInstance() +
            '}')
    }
