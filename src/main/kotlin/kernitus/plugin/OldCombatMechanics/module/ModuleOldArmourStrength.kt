...
/**
 * Reverts the armour strength changes to 1.8 calculations, including enchantments. Also recalculates resistance and
 * absorption accordingly.
 *
 * It is based on [this revision](https://minecraft.gamepedia.com/index.php?title=Armor&oldid=909187) of the minecraft
 * wiki.
 */
class ModuleOldArmourStrength(plugin: OCMMain) : OCMModule(plugin, "old-armour-strength") {
    ...
    fun onEntityDamage(e: EntityDamageEvent) {
        ...
        val damageModifiers =
            DamageModifier.entries.filter { e.isApplicable(it) }.associateWith { e.getDamage(it) }.toMutableMap()
