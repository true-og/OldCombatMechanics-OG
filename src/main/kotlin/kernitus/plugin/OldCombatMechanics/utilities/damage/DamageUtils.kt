...
object DamageUtils {
    ...
    private val isInWater: SpigotFunctionChooser<LivingEntity, Any, Boolean> =
    ...
    fun isCriticalHit1_8(humanEntity: HumanEntity): Boolean {
        ...
        */
        return humanEntity.fallDistance > 0.0f &&
            !humanEntity.isOnGround &&
            !isClimbing(humanEntity) &&
            !isInWater(humanEntity) &&
            humanEntity.activePotionEffects
                .stream()
                .map { obj: PotionEffect -> obj.type }
                .noneMatch { e: PotionEffectType -> e === PotionEffectType.BLINDNESS } &&
