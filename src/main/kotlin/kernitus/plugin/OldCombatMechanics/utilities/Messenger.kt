...
object Messenger {
    ...
    /**
     * This will format any ampersand (&) color codes, format any args passed to it using [String.format], and then send
     * the message to the specified [CommandSender].
     *
    ...
    /**
     * This will add the prefix to the message, format any ampersand (&) color codes, format any args passed to it using
     * [String.format], and then send the message to the specified [CommandSender].
     *
     * @param sender The [CommandSender] to send the message to.
     * @param message The message to send.
