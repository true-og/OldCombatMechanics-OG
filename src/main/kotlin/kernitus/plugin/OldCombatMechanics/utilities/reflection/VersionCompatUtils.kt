...
object VersionCompatUtils {
    ...
    /**
     * Returns a Craft object from the given Spigot object, e.g. CraftPlayer from Player. Useful for accessing
     * properties not available through Spigot's API.
     *
    ...
    fun getAbsorptionAmount(livingEntity: LivingEntity): Float {
        ...
        require(absorptionAmountMethod!!.declaringClass.isAssignableFrom(craftLivingEntity.javaClass)) {
            ("Cannot call method '" +
                absorptionAmountMethod +
                "' of class '" +
                absorptionAmountMethod.declaringClass.name +
                "' using object '" +
                craftLivingEntity +
                "' of class '" +
                craftLivingEntity.javaClass.name +
                "' because" +
                " object '" +
                craftLivingEntity +
