...
class FakePlayer {
    ...
    fun spawn(location: Location) {
        ...
        // PlayerLoginEvent playerLoginEvent = new PlayerLoginEvent((Player) entityPlayer, "hostname", ipAddress,
        // ipAddress);
        ...
        val playersByUUIDField =
            Reflector.getMapFieldWithTypes(PlayerList::class.java, UUID::class.java, ServerPlayer::class.java)
    ...
    fun updateEquipment(slot: EquipmentSlot?, item: ItemStack?) {
        ...
        //         ((ServerLevel) this.level).getChunkSource().broadcast(this, new
        // PacketPlayOutEntityEquipment(this.getId(), list));
    }
    ...
    fun doBlocking() {
        ...
        val useItemRemainingField = Reflector.getField(LivingEntity::class.java, remapped)
