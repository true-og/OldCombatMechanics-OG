...
class PotionTypeCompat {
    ...
    /**
     * Create an instance of [PotionTypeCompat] starting from the new potion name. (>=1.20.5) Name will be turned into
    ...
    /**
     * Create an instance of [PotionTypeCompat] starting from the old potion name. (<1.20.5) Name will be turned into
     * upper case as needed.
     *
    ...
    constructor(oldName: String, isStrong: Boolean, isLong: Boolean) {
        ...
        if (newName == null) { // Name did not change
            ...
            else if (isLong) this.newName = "LONG_" + this.oldName else this.newName = this.oldName
