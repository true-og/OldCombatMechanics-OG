...
class OCMMain : JavaPlugin() {
    ...
    override fun onEnable() {
        ...
        val joinListeners = PlayerJoinEvent.getHandlerList().registeredListeners.filter { it.plugin == this }
    ...
    override fun onDisable() {
        ...
        // Properly handle Plugman load/unload.
        val quitListeners = PlayerQuitEvent.getHandlerList().registeredListeners.filter { it.plugin == this }
